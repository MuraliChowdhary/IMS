...
exports.deleteOrder =
  ...
  exports.getSalesByRegion =
  exports.getSalesByCustomer =
  exports.getOrderById =
  exports.getOrders =
  exports.getTopProducts =
  exports.getSalesOverview =
    void 0;
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      const parsedStatus = status
        ? client_1.OrderStatus_new[status]
        : undefined;
...
const getSalesByCustomer = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
...
// GET: Sales by Region
const getSalesByRegion = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
