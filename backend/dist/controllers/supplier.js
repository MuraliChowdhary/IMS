...
exports.updateShippingStatus =
  exports.initiateQualityCheck =
  exports.updateProductionStatus =
  exports.reviewPriceProposal =
  exports.proposePriceForOrder =
  exports.retriveOrders =
    void 0;
const client_1 = require("@prisma/client");
const prisma = new client_1.PrismaClient();
const retriveOrders = (req, res) =>
...
const proposePriceForOrder = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    const { orderId } = req.params;
        ...
        data: {
          ...
          statusHistory: {
            create: {
              ...
              comments: `Price proposed by supplier: ${
                (_b =
...
const updateProductionStatus = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { orderId } = req.params;
...
const initiateQualityCheck = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { orderId } = req.params;
