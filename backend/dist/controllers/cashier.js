...
const processPayment = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      //     ]);
      // });
      const transactionPromises = order.products.map((product) =>
        __awaiter(void 0, void 0, void 0, function* () {
          var _a;
          ...
          if (!inventory) {
            throw new Error(
              `Inventory record not found for Product ID ${product.productId}`
            );
          }
          if (!inventory) {
            throw new Error(
...
const generateReceipt = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      doc
        .fontSize(10)
        .text("Address: Warangal Hanmakonda, 23-10", { align: "center" });
...
const productAvilability = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
